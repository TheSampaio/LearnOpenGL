...
int main(void)
{
    ...
    Texture dWoodFloor("D_Wood_01.png", GL_TEXTURE_2D, 0, GL_RGBA, GL_UNSIGNED_BYTE); // Create a diffuse texture
    dWoodFloor.texUnit(shaderProgram, "tex0", 0);                                     // Gets uniform "tex0" for the created diffuse texture's location

    Texture sWoodFloor("S_Wood_01.png", GL_TEXTURE_2D, 1, GL_RED, GL_UNSIGNED_BYTE); // Create a specular texture
