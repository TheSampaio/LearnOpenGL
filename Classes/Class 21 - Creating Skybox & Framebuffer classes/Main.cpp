...
int main(void)
{
    ...
    // Shader programs
    Shader framebufferProgram("framebuffer.vert", "framebuffer.frag"); // Create Shader Program (Framebuffer)
    ...
    // Skybox and framebuffers
    Skybox skybox;
    Framebuffer framebuffer(MainCamera);
