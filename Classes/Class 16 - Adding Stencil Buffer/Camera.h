...
{
public:
	Camera(int width, int height, float sentibility, float speed, float aspectRatio, glm::vec3 position); // Camera's contructor
	...
	void Matrix(Shader& shader, const char* uniform); // Initialize camera's matrix
};
#endif