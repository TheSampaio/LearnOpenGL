...
GLfloat vertices[] =
{//       COORDINATES       //         COLORS          //
	-0.5f,  -0.5f,   0.0f,      0.0f,   0.1f,   1.0f,  // Lower left corner
	-0.5f,	 0.5f,	 0.0f,	    0.5f,   1.0f,   1.0f,  // Upper left corner
	 0.5f,	 0.5f,	 0.0f,      0.5f,   1.0f,   1.0f,  // Upper right corner
	 0.5f,	-0.5f,	 0.0f,      0.0f,   0.1f,   1.0f,  // Lower right corner
};
