...
const std::vector<Vertex> pyramidVertices
{
    ...
    Vertex{ glm::vec3{  0.0f, 0.8f,  0.0f },  glm::vec3{ 1.0f, 1.0f, 1.0f },  glm::vec3{ -0.8f, 0.5f, 0.0f },  glm::vec2{ 0.5f, 1.0f } },    // Left Side
    ...
    Vertex{ glm::vec3{  0.0f, 0.8f,  0.0f },  glm::vec3{ 1.0f, 1.0f, 1.0f },  glm::vec3{ 0.0f, 0.5f, -0.8f },  glm::vec2{ 0.5f, 1.0f } } ,    // Back side
    ...
    Vertex{ glm::vec3{  0.0f, 0.8f,  0.0f },  glm::vec3{ 1.0f, 1.0f, 1.0f },  glm::vec3{ 0.8f, 0.5f,  0.0f },  glm::vec2{ 0.5f, 1.0f } },    // Right side
    ...
    Vertex{ glm::vec3{  0.0f, 0.8f,  0.0f },  glm::vec3{ 1.0f, 1.0f, 1.0f },  glm::vec3{ 0.0f, 0.5f,  0.8f },  glm::vec2{ 0.5f, 1.0f } }     // Front side
};
