...
Texture::Texture(const char* filePath, GLenum iFormat, GLenum eFormat, GLenum slot, GLenum filter)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, iFormat, m_Size[0], m_Size[1], 0, eFormat, GL_UNSIGNED_BYTE, bytes);
