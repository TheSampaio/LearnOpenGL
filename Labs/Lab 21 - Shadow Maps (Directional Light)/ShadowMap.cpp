...
ShadowMap::ShadowMap()
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT, m_Size[0], m_Size[1], 0, GL_DEPTH_COMPONENT, GL_FLOAT, NULL);
    ...
    m_Orthographic = glm::ortho(-2.0f, 2.0f, -2.0f, 2.0f, 0.2f, 64.0f);
    m_View = glm::lookAt(20.0f * glm::vec3{ 0.5f, 1.0, -1.5 }, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
